...
<body>
    <div class="container" style="margin-top:20px;">
        ...
        ?>
        <form method="post">
            <div class="search-container center" style="width:70%;"><input type="text" name="search-bar" placeholder="Найти Match ID, Ник или SteamID64" class="search-input"><button class="btn btn-light search-btn" type="submit" name="Submit"> <i class="fa fa-search"></i></button></div>
        </form>
<?php
    ...
    if($result->num_rows > 0) {
        ...
        echo '<h1 style="margin-top:20px;text-align:center;">Нет результатов!</h1>';
    }
?>
<?php
...
?>
    </div><a class="text-white" href="https://github.com/eastsidekillas/SourceModWebStats" target="_blank" style="position:fixed;bottom:0px;right:10px;">Developed by eastsidekillas</a>
